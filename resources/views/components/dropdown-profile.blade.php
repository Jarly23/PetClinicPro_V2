...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400 italic"> {{ Auth::user()->getRoleNames()->first() ?? 'Sin rol' }}</div>
        </div>
        <ul>
            <li>
                <a class="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" href="{{ route('profile.show') }}" @click="open = false" @focus="open = true" @focusout="open = false">Configuracion</a>
            </li>
            <li>
