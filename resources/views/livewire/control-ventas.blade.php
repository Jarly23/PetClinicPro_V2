<div class="min-h-screen bg-gray-100 p-6 md:p-8">
  <div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Sección: Ventas de hoy + Entradas/Salidas + Stock Bajo -->
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            @if($entryProductsToday->count())
              <ul class="bg-green-50 border rounded-md p-3 max-h-52 overflow-y-auto space-y-2">
          ...
          <div>
            ...
            @if($exitProductsToday->count())
              <ul class="bg-red-50 border rounded-md p-3 max-h-52 overflow-y-auto space-y-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section class="bg-white rounded-2xl shadow p-6 max-w-7xl mx-auto" style="width: 100%; height: 400px;">
        <h2 class="text-xl font-semibold text-gray-900 mb-6">Productos más vendidos </h2>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', () => {
          ...
          const rawLabels = [
            @foreach($topSellingProducts as $detalle)
              "{{ addslashes($detalle->product->name ?? 'Producto no encontrado') }}",
            @endforeach
          ];
          ...
          // Genera un color diferente para cada barra (colores pastel variados)
            ...
            options: {
              ...
              scales: {
                ...
                x: {
                  ...
                  title: {
                    display: false // Ocultamos el título del eje X (Productos)
                  }
                }
              },
              plugins: {
