    ...
    <div class="mb-6">
        <h2 class="text-2xl md:text-3xl font-bold text-blue-700 flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                <path d="M16 14c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm-8 0c2.21 0 4-1.79 4-4S10.21 6 8 6 4 7.79 4 10s1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 2.06 1.97 3.45v1.5h6v-1.5c0-2.66-5.33-4-8-4z"/>
            </svg>
            Gestión de Proveedores
        </h2>
        <p class="text-sm text-gray-600 mt-1">Aquí puedes registrar, editar y buscar proveedores de tu inventario.</p>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center text-gray-500 py-4">No se encontraron proveedores.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
