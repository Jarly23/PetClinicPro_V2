            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm text-left">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 font-semibold text-gray-700">Nombre del Rol</th>
                        <th class="px-6 py-3 font-semibold text-gray-700 text-center">Acciones</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                    @forelse ($roles as $role)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 text-gray-800">{{ $role->id }}</td>
                            <td class="px-6 py-4 text-gray-800">{{ ucfirst($role->name) }}</td>
