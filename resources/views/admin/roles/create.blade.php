<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="bg-white p-6 shadow rounded-lg dark:bg-gray-800">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Crear nuevo rol</h2>
            <div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2  gap-4">
                                @foreach ($permissions as $permission)
                                    <div
                                        class="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-md shadow-sm hover:bg-gray-100 transition dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            ...
                                            <div
                                                class="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-blue-600 dark:bg-gray-800 dark:peer-checked:bg-blue-600 transition-colors duration-300">
                                            </div>
                                            <div
                ...
                <div>
                    {!! Form::submit('Crear Rol', [
                        'class' =>
                            'bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700',
                    ]) !!}
                </div>
                {!! Form::close() !!}
            </div>
