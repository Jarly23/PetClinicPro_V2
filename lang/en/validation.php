...
return [
    ...
    */
    ...
    | especificar un mensaje personalizado específico para una regla dada.
    |
    */
    ...
    | del atributo por algo más amigable para el lector, como "Correo electrónico"
    | en lugar de "email". Esto ayuda a que nuestros mensajes sean más expresivos.
    |
    */
